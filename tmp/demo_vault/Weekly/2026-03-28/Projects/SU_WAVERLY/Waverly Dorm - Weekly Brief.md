...
# Waverly Dorm Weekly Brief

[[Portfolio Weekly Summary]] | [[Weekly/2026-03-21/Projects/SU_WAVERLY/Waverly Dorm - Weekly Brief|Prior Week]]

## Executive Signal

- Health Score: **13.0**
- Risk Level: **HIGH**
- Executive Summary: Waverly Dorm is critical at a score of 13.0. Schedule logic still contains 2 cycle(s).

## What Changed This Week

- Project: SU_WAVERLY
- Schedule: Schedule held flat versus the prior run.
- Financial: Financial posture was effectively unchanged.
- Risk: No material risk movement was detected against the prior run.
...
- Finish Date: **n/a**
- Schedule Health: **50.0**
- Open Starts / Finishes: **30 / 101**
- Negative Float Activities: **0**
...
- Current trust: **Partial**
- Flags: schedule_parser_warning_elevated
