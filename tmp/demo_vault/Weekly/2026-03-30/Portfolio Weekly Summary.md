...
- Generated at: `2026-03-30T17:35:55Z`
- Active projects: **2**
...
- SU_WAVERLY: no date movement versus the prior run.

- SAMPLE_DATA: no date movement versus the prior run.
...
- SU_WAVERLY: Scheduler to Validate and remove 2 schedule cycle(s) before the next publish. Timing: before next publish. Impact: Projected finish: 2027-08-16. Movement vs prior trusted run: 0 days. Risk level remains HIGH.

- SAMPLE_DATA: Scheduler to Validate and remove 2 schedule cycle(s) before the next publish. Timing: before next publish. Impact: Projected finish: 2026-03-03. Movement vs prior trusted run: 0 days.
...
- **SU_WAVERLY**: Waverly Dorm is critical at a score of 13.0. Schedule logic still contains 2 cycle(s). Current finish: 2027-08-16.

- **SAMPLE_DATA**: sample data is watch at a score of 73.3. Schedule logic still contains 2 cycle(s). Current finish: 2026-03-03.
