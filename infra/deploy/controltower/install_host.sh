...
install -m 0644 "$TMP_DIR/controltower-nginx.conf" "$CONTROLTOWER_NGINX_SITE_AVAILABLE_DIR/$CONTROLTOWER_DOMAIN.conf"
ln -sfn "$CONTROLTOWER_NGINX_SITE_AVAILABLE_DIR/$CONTROLTOWER_DOMAIN.conf" "$CONTROLTOWER_NGINX_SITE_ENABLED_DIR/$CONTROLTOWER_DOMAIN.conf"
...
echo "Installed nginx site: $CONTROLTOWER_NGINX_SITE_AVAILABLE_DIR/$CONTROLTOWER_DOMAIN.conf"
